...
var addCustom =function(data){
	...
	data.guests.forEach(function(value,index){
		if(index % 2 == 0){    //偶数放左边
			...
			var str = "<div class='left-host'><div class='host-logo fr'><div class='host-logo-wrap'><img src='"+value.avatar+"' alt='头像' height='38' width='38'></div>";
		...
		sell.style.height= (index/2) * 46 + 20 * (index/2) + 20 + 46 +"px";
	})
}
